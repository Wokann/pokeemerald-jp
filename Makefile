...
$(OBJ_DIR)/data/data_b2d_mid60_tail.o: data/data_b2d_mid60_tail.s baserom_jp.gba
	@mkdir -p $(dir $@)
	@set -o pipefail; $(PREPROC) $< charmap.txt | $(AS) $(ASFLAGS) -o $@ -
...
$(OBJ_DIR)/data/data_b2d_mid101_tail.o: data/data_b2d_mid101_tail.s baserom_jp.gba
	@mkdir -p $(dir $@)
	@set -o pipefail; $(PREPROC) $< charmap.txt | $(AS) $(ASFLAGS) -o $@ -
