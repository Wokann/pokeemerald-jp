...
C_SRCS := src/load_save.c src/hof_pc.c src/decompress.c src/util.c src/text_window.c src/random.c src/heal_location.c src/landmark.c src/trig.c src/dynamic_placeholder_text_util.c src/gym_leader_rematch.c src/birch_pc.c src/fldeff_strength.c src/fldeff_teleport.c src/fldeff_rocksmash.c src/fldeff_dig.c src/fldeff_sweetscent.c src/fldeff_softboiled.c src/fldeff_flash.c src/fldeff_cut.c src/fldeff_escalator.c src/field_poison.c
