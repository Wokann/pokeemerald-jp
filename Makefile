...
DATA_OBJS := $(OBJ_DIR)/data/event_scripts.o $(OBJ_DIR)/data/data.o $(OBJ_DIR)/data/data_b.o $(OBJ_DIR)/data/data_b_mid1.o $(OBJ_DIR)/data/data_b_mid2a.o $(OBJ_DIR)/data/data_b_mid2b.o $(OBJ_DIR)/data/data_b_mid2b3.o $(OBJ_DIR)/data/data_b_mid2b5.o $(OBJ_DIR)/data/data_b_mid2b6.o $(OBJ_DIR)/data/data_b2.o $(OBJ_DIR)/data/data_b2b.o $(OBJ_DIR)/data/data_b2d.o $(OBJ_DIR)/data/data_b2d_mid.o $(OBJ_DIR)/data/data_b2d_mid8.o $(OBJ_DIR)/data/data_b2d_mid41.o $(OBJ_DIR)/data/data_b2d_mid44.o $(OBJ_DIR)/data/data_b2d_mid45.o $(OBJ_DIR)/data/data_b2d_mid47.o $(OBJ_DIR)/data/data_b2d_mid51.o $(OBJ_DIR)/data/data_b2d_mid49.o $(OBJ_DIR)/data/data_b2d_mid50.o $(OBJ_DIR)/data/data_b2d_mid52.o $(OBJ_DIR)/data/data_b2d_mid7.o $(OBJ_DIR)/data/data_b2d_mid30.o $(OBJ_DIR)/data/data_b2d_mid28.o $(OBJ_DIR)/data/data_b2d_mid29.o $(OBJ_DIR)/data/data_b2d_mid31.o $(OBJ_DIR)/data/data_b2d_mid26.o $(OBJ_DIR)/data/data_b2d_mid15.o $(OBJ_DIR)/data/data_b2d_mid54.o $(OBJ_DIR)/data/data_b2d_mid55.o $(OBJ_DIR)/data/data_b2d_mid56.o $(OBJ_DIR)/data/data_b2d_mid57_a.o $(OBJ_DIR)/data/data_b2d_mid57_gap.o $(OBJ_DIR)/data/data_b2d_mid57_b.o $(OBJ_DIR)/data/data_b2d_mid58.o $(OBJ_DIR)/data/data_b2d_mid59.o $(OBJ_DIR)/data/data_b2d_mid34.o $(OBJ_DIR)/data/data_b2d_mid36.o $(OBJ_DIR)/data/data_b2d_mid37.o $(OBJ_DIR)/data/data_b2d_mid60.o $(OBJ_DIR)/data/data_b2d_mid61.o $(OBJ_DIR)/data/data_b2d_mid62.o $(OBJ_DIR)/data/data_b2d_mid38.o $(OBJ_DIR)/data/data_b2d_mid33.o $(OBJ_DIR)/data/data_b2d_mid63.o $(OBJ_DIR)/data/data_b2d_mid39.o $(OBJ_DIR)/data/data_b2d_mid64.o $(OBJ_DIR)/data/data_b2d_mid32.o $(OBJ_DIR)/data/data_b2d_mid65.o $(OBJ_DIR)/data/data_b2d_rest.o $(OBJ_DIR)/data/data_b2d_mid66.o $(OBJ_DIR)/data/data_b2d_mid67.o $(OBJ_DIR)/data/data_b2d_mid68.o $(OBJ_DIR)/data/data_b2d_mid69.o $(OBJ_DIR)/data/data_b2d_mid70.o $(OBJ_DIR)/data/data_b2d_mid72.o $(OBJ_DIR)/data/data_b2d_mid73.o $(OBJ_DIR)/data/data_b2d_mid74.o $(OBJ_DIR)/data/data_b2d_mid75.o $(OBJ_DIR)/data/data_b2d_mid76.o $(OBJ_DIR)/data/data_b2d_mid78.o $(OBJ_DIR)/data/data_b2d_mid80.o $(OBJ_DIR)/data/data_b2d_mid81.o $(OBJ_DIR)/data/data_b2d_mid82.o $(OBJ_DIR)/data/data_b2d_mid83.o $(OBJ_DIR)/data/data_b2d_mid85.o $(OBJ_DIR)/data/data_b2d_mid86.o $(OBJ_DIR)/data/data_b2d_mid88.o $(OBJ_DIR)/data/data_b2d_mid89.o $(OBJ_DIR)/data/data_b2d_mid90.o $(OBJ_DIR)/data/data_b2d_mid93.o $(OBJ_DIR)/data/data_b2d_mid94.o $(OBJ_DIR)/data/data_b2d_mid96.o $(OBJ_DIR)/data/data_b2d_mid97.o $(OBJ_DIR)/data/data_b2d_mid98.o $(OBJ_DIR)/data/data_b2d_mid99.o $(OBJ_DIR)/data/data_b2d_mid100.o $(OBJ_DIR)/data/data_b2d_mid101.o $(OBJ_DIR)/data/data_b2c_mid1.o $(OBJ_DIR)/data/data_b2c_mid2.o $(OBJ_DIR)/data/data_b2c_mid3.o $(OBJ_DIR)/data/data_b2c_mid4.o $(OBJ_DIR)/data/data_b2c_mid5.o $(OBJ_DIR)/data/data_b2c_mid6.o $(OBJ_DIR)/data/data_b2c_mid7.o $(OBJ_DIR)/data/data_b2c_mid8.o $(OBJ_DIR)/data/data_b2c_mid8_tail.o $(OBJ_DIR)/data/data_rest.o $(OBJ_DIR)/data/data_rest2.o $(OBJ_DIR)/data/data_b2d_gfx_pokemon_none.o $(OBJ_DIR)/data/data_rest2b.o $(OBJ_DIR)/data/data_b2d_gfx_pokemon_main.o $(OBJ_DIR)/data/data_rest2c.o $(OBJ_DIR)/data/data_b2d_gfx_front.o $(OBJ_DIR)/data/multiboot_ereader.o $(OBJ_DIR)/data/multiboot_berry_glitch_fix.o
...
$(OBJ_DIR)/data/data_b2d_mid57_gap.o: data/data_b2d_mid57_gap.s baserom_jp.gba
	@mkdir -p $(dir $@)
	@set -o pipefail; $(PREPROC) $< charmap.txt | $(AS) $(ASFLAGS) -o $@ -
...
$(OBJ_DIR)/data/data_b2c_mid1.o: data/data_b2c_mid1.s baserom_jp.gba
	@mkdir -p $(dir $@)
	@set -o pipefail; $(PREPROC) $< charmap.txt | $(AS) $(ASFLAGS) -o $@ -
