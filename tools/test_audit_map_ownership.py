#!/usr/bin/env python3
"""Regression checks for the map ownership report."""
...
import audit_map_ownership as audit


class MapOwnershipTests(unittest.TestCase):
    def test_report_keeps_raw_ranges_and_final_owners_separate(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            (root / "data/maps/connections.inc").write_text(
