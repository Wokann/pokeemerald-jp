...
# Dewford Hall was previously hand-named, but was not represented in the
# generator's reviewed metadata.  Its 36 scripts, two movement streams, and
# 26 text records match the corresponding US source in physical JP ROM order.
# In particular, the recurring FD 02/03 controls are the trendy-phrase
# buffers STR_VAR_1/STR_VAR_2, not generic STRING placeholders.
MAP_VERIFIED_SEMANTIC_LABELS.update({
    'DewfordTown_Hall': {
        'scripts': {
            0x081F3789: 'DewfordTown_Hall_EventScript_Girl',
            0x081F37A8: 'DewfordTown_Hall_EventScript_GirlBoredOfTrend',
            0x081F37B2: 'DewfordTown_Hall_EventScript_Woman',
            0x081F37C3: 'DewfordTown_Hall_EventScript_Man',
            0x081F37EC: 'DewfordTown_Hall_EventScript_ConfirmTrendLink',
            0x081F37F6: 'DewfordTown_Hall_EventScript_RejectTrendLink',
            0x081F3800: 'DewfordTown_Hall_EventScript_ExpertM',
            0x081F381C: 'DewfordTown_Hall_EventScript_Twin',
            0x081F3838: 'DewfordTown_Hall_EventScript_LittleBoy',
            0x081F3849: 'DewfordTown_Hall_EventScript_Bookshelf',
            0x081F3859: 'DewfordTown_Hall_EventScript_Painting',
            0x081F38C0: 'DewfordTown_Hall_EventScript_ScreamTitle',
            0x081F38CA: 'DewfordTown_Hall_EventScript_SmileTitle',
            0x081F38D4: 'DewfordTown_Hall_EventScript_LastTitle',
            0x081F38DE: 'DewfordTown_Hall_EventScript_BirthTitle',
            0x081F38E8: 'DewfordTown_Hall_EventScript_SchoolKidM',
            0x081F38F4: 'DewfordTown_Hall_EventScript_PsychicM',
            0x081F3900: 'DewfordTown_Hall_EventScript_DoTrendDebate',
            0x081F3966: 'DewfordTown_Hall_EventScript_TrendDebate1',
            0x081F3982: 'DewfordTown_Hall_EventScript_TrendDebate2',
            0x081F399E: 'DewfordTown_Hall_EventScript_TrendDebate3',
            0x081F39BA: 'DewfordTown_Hall_EventScript_TrendDebate4',
            0x081F39D6: 'DewfordTown_Hall_EventScript_TrendDebate5',
            0x081F39F2: 'DewfordTown_Hall_EventScript_DontMovePlayer1',
            0x081F39F3: 'DewfordTown_Hall_EventScript_DebateReact1',
            0x081F3A14: 'DewfordTown_Hall_EventScript_PlayerReactWest',
            0x081F3A2A: 'DewfordTown_Hall_EventScript_DontMovePlayer2',
            0x081F3A2B: 'DewfordTown_Hall_EventScript_DebateReact2',
            0x081F3A4C: 'DewfordTown_Hall_EventScript_PlayerReactNorthSouth',
            0x081F3A63: 'DewfordTown_Hall_EventScript_PlayerWalkInPlaceUp',
            0x081F3A6E: 'DewfordTown_Hall_EventScript_PlayerWalkInPlaceDown',
            0x081F3A79: 'DewfordTown_Hall_EventScript_PlayerReactEast',
            0x081F3A93: 'DewfordTown_Hall_EventScript_SludgeBombMan',
            0x081F3AC7: 'DewfordTown_Hall_EventScript_ReceivedSludgeBomb',
        },
        'texts': {
            0x081F3AD1: 'DewfordTown_Hall_Text_CantImagineLifeWithoutTrend',
            0x081F3B09: 'DewfordTown_Hall_Text_GettingBoredOfTrend',
            0x081F3B4C: 'DewfordTown_Hall_Text_TeachingMonAboutTrend',
            0x081F3B7C: 'DewfordTown_Hall_Text_DeepLinkBetweenXAndY',
            0x081F3BC8: 'DewfordTown_Hall_Text_MyHunchWasRight',
            0x081F3BF5: 'DewfordTown_Hall_Text_NotEasyToKeepUp',
            0x081F3C23: 'DewfordTown_Hall_Text_TVShowAboutTrend',
            0x081F3C40: 'DewfordTown_Hall_Text_IsTrendMorePopularAcrossSea',
            0x081F3C5E: 'DewfordTown_Hall_Text_CollectTrendMerchandise',
            0x081F3CBC: 'DewfordTown_Hall_Text_BooksAboutTrend',
            0x081F3D0D: 'DewfordTown_Hall_Text_TrendsScream',
            0x081F3D26: 'DewfordTown_Hall_Text_TrendsSmile',
            0x081F3D40: 'DewfordTown_Hall_Text_LastTrend',
            0x081F3D59: 'DewfordTown_Hall_Text_BirthOfTrend',
            0x081F3D74: 'DewfordTown_Hall_Text_SawTrendCoolestThing',
            0x081F3DA2: 'DewfordTown_Hall_Text_AllegedTrendNotAuthentic',
            0x081F3DF4: 'DewfordTown_Hall_Text_ComposedTrendThemeSong',
            0x081F3E3C: 'DewfordTown_Hall_Text_WorkOnYourSinging',
            0x081F3E61: 'DewfordTown_Hall_Text_OrganizeTrendParty',
            0x081F3E8F: 'DewfordTown_Hall_Text_BrilliantIndeed',
            0x081F3ECA: 'DewfordTown_Hall_Text_TrendHasBecomePartOfLife',
            0x081F3EFD: 'DewfordTown_Hall_Text_TrendWeighsHeavilyOnMind',
            0x081F3F3E: 'DewfordTown_Hall_Text_IfWeTeamUpWellBeInvincible',
            0x081F3F65: 'DewfordTown_Hall_Text_WellBeTrendDuo',
            0x081F3F87: 'DewfordTown_Hall_Text_GiveYouSludgeBomb',
            0x081F3FDC: 'DewfordTown_Hall_Text_LoveSludgeBombButTrendInToo',
        },
        'field_placeholders': {
            0x081F3AD1: {0x02: 'STR_VAR_1'},
            0x081F3B09: {0x02: 'STR_VAR_1'},
            0x081F3B4C: {0x02: 'STR_VAR_1'},
            0x081F3B7C: {0x02: 'STR_VAR_1', 0x03: 'STR_VAR_2'},
            0x081F3C23: {0x02: 'STR_VAR_1'},
            0x081F3C40: {0x02: 'STR_VAR_1'},
            0x081F3C5E: {0x02: 'STR_VAR_1'},
            0x081F3CBC: {0x02: 'STR_VAR_1'},
            0x081F3D0D: {0x02: 'STR_VAR_1'},
            0x081F3D26: {0x02: 'STR_VAR_1'},
            0x081F3D40: {0x02: 'STR_VAR_1'},
            0x081F3D59: {0x02: 'STR_VAR_1'},
            0x081F3D74: {0x02: 'STR_VAR_1'},
            0x081F3DA2: {0x02: 'STR_VAR_1'},
            0x081F3DF4: {0x02: 'STR_VAR_1'},
            0x081F3E3C: {0x02: 'STR_VAR_1'},
            0x081F3E61: {0x02: 'STR_VAR_1'},
            0x081F3E8F: {0x02: 'STR_VAR_1'},
            0x081F3ECA: {0x02: 'STR_VAR_1'},
            0x081F3EFD: {0x02: 'STR_VAR_1'},
            0x081F3F3E: {0x02: 'STR_VAR_1'},
            0x081F3F65: {0x02: 'STR_VAR_1'},
            0x081F3FDC: {0x02: 'STR_VAR_1'},
        },
        'external_labels': {
            0x08242F17: 'Common_EventScript_BufferTrendyPhrase',
            0x082430E0: 'Common_EventScript_ShowBagIsFull',
            0x08243627: 'Common_Movement_WalkInPlaceFasterLeft',
            0x08243629: 'Common_Movement_WalkInPlaceFasterUp',
            0x0824362B: 'Common_Movement_WalkInPlaceFasterRight',
        ...
        'preserve_region_text_aliases': False,
        'symbols': {
            'flags': {0x00E6: 'FLAG_RECEIVED_TM_SLUDGE_BOMB'},
            'vars': {
                0x8000: 'VAR_0x8000',
                0x8001: 'VAR_0x8001',
                0x8008: 'VAR_0x8008',
            ...
            'script_var_values': {
                0x081F3789: {0x800D: {0x01: 'TRUE'}},
                0x081F39F3: {0x8008: {0x00: '0', 0x01: '1'}},
                0x081F3A2B: {0x8008: {0x00: '0', 0x01: '1'}},
            },
            'local_ids': {
                0x04: 'LOCALID_DEWFORD_HALL_EXPERT_M',
                0x05: 'LOCALID_DEWFORD_HALL_TWIN',
                0x07: 'LOCALID_DEWFORD_HALL_SCHOOL_KID_M',
                0x08: 'LOCALID_DEWFORD_HALL_PSYCHIC_M',
                0xFF: 'LOCALID_PLAYER',
            },
            'items': {0x0144: 'ITEM_TM_SLUDGE_BOMB'},
            'decimal_arguments': {
                'call_if': (1,),
                'goto_if': (1,),
                'setvar': (1,),
...
MAP_MOVEMENT_SCRIPT_LABELS.update({
    'DewfordTown_Hall': {
        ...
        0x081F3A91: 'DewfordTown_Hall_Movement_SchoolKidWalkInPlaceRight',
    },
})
...
# The immediately following Pokémon Center 2F table has four shared Cable
# Club hooks and three complete unused RS-era wrappers. Retain every byte as
# reviewed semantic roots instead of a raw local tail.
MAP_AUXILIARY_SCRIPT_ADDRESSES.update({
...
MAP_VERIFIED_SEMANTIC_LABELS.update({
    'PacifidlogTown_PokemonCenter_2F': {
        'scripts': {
            0x081F792C: 'PacifidlogTown_PokemonCenter_2F_EventScript_Colosseum',
            0x081F7932: 'PacifidlogTown_PokemonCenter_2F_EventScript_TradeCenter',
            0x081F7938: 'PacifidlogTown_PokemonCenter_2F_EventScript_RecordCorner',
        },
        'external_labels': {
            0x082467CD: 'CableClub_OnTransition',
            0x0824686A: 'CableClub_OnWarp',
...
MAP_VERIFIED_SEMANTIC_LABELS.update({
    ...
    'RustboroCity_Flat1_1F': {
        'scripts': {
            0x08203715: 'RustboroCity_Flat1_1F_EventScript_Man',
            0x0820371E: 'RustboroCity_Flat1_1F_EventScript_Woman',
        },
        'texts': {
            0x08203727: 'RustboroCity_Flat1_1F_Text_EveryPokemonHasAbility',
            0x08203755: 'RustboroCity_Flat1_1F_Text_PokemonStrange',
        },
        'preserve_region_script_aliases': False,
        'preserve_region_text_aliases': False,
    },
    ...
    'RustboroCity_Flat2_1F': {
        'scripts': {
            0x08203F9A: 'RustboroCity_Flat2_1F_EventScript_OldWoman',
            0x08203FA3: 'RustboroCity_Flat2_1F_EventScript_Skitty',
        },
        'texts': {
            0x08203FB6: 'RustboroCity_Flat2_1F_Text_DevonWorkersLiveHere',
            0x08203FDE: 'RustboroCity_Flat2_1F_Text_Skitty',
        },
        'command_aliases': {
            0x08203FA3: {'waitdooranim': 'waitmoncry_jp'},
        },
        'symbols': {
            'species': {0x013B: 'SPECIES_SKITTY'},
            'cry_modes': {0x00: 'CRY_MODE_NORMAL'},
    ...
    'RustboroCity_Flat2_3F': {
        'scripts': {
            0x082040B6: 'RustboroCity_Flat2_3F_EventScript_DevonEmployee',
            0x082040BF: 'RustboroCity_Flat2_3F_EventScript_Woman',
        },
        'texts': {
            0x082040C8: 'RustboroCity_Flat2_3F_Text_PresidentCollectsRareStones',
            0x082040EE: 'RustboroCity_Flat2_3F_Text_PresidentsSonAlsoCollectsRareStones',
        },
        'preserve_region_script_aliases': False,
        'preserve_region_text_aliases': False,
    },
    'RustboroCity_House3': {
        'scripts': {
            0x08204118: 'RustboroCity_House3_EventScript_OldMan',
            0x08204121: 'RustboroCity_House3_EventScript_OldWoman',
            0x0820412A: 'RustboroCity_House3_EventScript_Pekachu',
        },
        'texts': {
            0x0820413D: 'RustboroCity_House3_Text_IGivePerfectlySuitedNicknames',
            0x0820416F: 'RustboroCity_House3_Text_NamingPikachuPekachu',
            0x082041BF: 'RustboroCity_House3_Text_Pekachu',
        },
        'command_aliases': {
            0x0820412A: {'waitdooranim': 'waitmoncry_jp'},
        },
        'symbols': {
            'species': {0x0019: 'SPECIES_PIKACHU'},
            'cry_modes': {0x00: 'CRY_MODE_NORMAL'},
...
MAP_VERIFIED_SEMANTIC_LABELS.update({
    # Mauville Gym follows Slateport Mart. Its puzzle state machine, Wattson
    # battle flow, trainers, statues, and all text blocks match US in ROM
    # order; the JP owner has no opaque remainder.
    'MauvilleCity_Gym': {
        'scripts': {
            0x081FE9BA: 'MauvilleCity_Gym_OnLoad',
            0x081FEA00: 'MauvilleCity_Gym_EventScript_UpdateBarriers',
            0x081FEA0A: 'MauvilleCity_Gym_EventScript_SetAltBarriers',
            0x081FEAF5: 'MauvilleCity_Gym_EventScript_Switch1Pressed',
            0x081FEB03: 'MauvilleCity_Gym_EventScript_Switch2Pressed',
            0x081FEB11: 'MauvilleCity_Gym_EventScript_Switch3Pressed',
            0x081FEB1F: 'MauvilleCity_Gym_EventScript_Switch4Pressed',
            0x081FEB2D: 'MauvilleCity_Gym_EventScript_DeactivatePuzzle',
            0x081FEB31: 'MauvilleCity_Gym_EventScript_Wattson',
            0x081FEB71: 'MauvilleCity_Gym_EventScript_WattsonDefeated',
            0x081FEBD3: 'MauvilleCity_Gym_EventScript_GiveShockWave2',
            0x081FEBF7: 'MauvilleCity_Gym_EventScript_GiveShockWave',
            0x081FEC1A: 'MauvilleCity_Gym_EventScript_CompletedNewMauville',
            0x081FEC24: 'MauvilleCity_Gym_EventScript_WattsonRematch',
            0x081FEC3F: 'MauvilleCity_Gym_EventScript_Switch1',
            0x081FEC64: 'MauvilleCity_Gym_EventScript_Switch2',
            0x081FEC89: 'MauvilleCity_Gym_EventScript_Switch3',
            0x081FECAE: 'MauvilleCity_Gym_EventScript_Switch4',
            0x081FECD3: 'MauvilleCity_Gym_EventScript_PressFloorSwitch',
            0x081FECF3: 'MauvilleCity_Gym_EventScript_SwitchDoNothing',
            0x081FECF5: 'MauvilleCity_Gym_EventScript_SetBarriersAltState',
            0x081FECFA: 'MauvilleCity_Gym_EventScript_ClearBarriersAltState',
            0x081FECFF: 'MauvilleCity_Gym_EventScript_Kirk',
            0x081FED16: 'MauvilleCity_Gym_EventScript_Shawn',
            0x081FED2D: 'MauvilleCity_Gym_EventScript_Ben',
            0x081FED44: 'MauvilleCity_Gym_EventScript_Vivian',
            0x081FED5B: 'MauvilleCity_Gym_EventScript_Angelo',
            0x081FED72: 'MauvilleCity_Gym_EventScript_GymGuide',
            0x081FED87: 'MauvilleCity_Gym_EventScript_GymGuidePostVictory',
            0x081FED91: 'MauvilleCity_Gym_EventScript_LeftGymStatue',
            0x081FEDA1: 'MauvilleCity_Gym_EventScript_RightGymStatue',
            0x081FEDB1: 'MauvilleCity_Gym_EventScript_GymStatueCertified',
            0x081FEDBB: 'MauvilleCity_Gym_EventScript_GymStatue',
        },
        'texts': {
            0x081FEDC5: 'MauvilleCity_Gym_Text_GymGuideAdvice',
            0x081FEE65: 'MauvilleCity_Gym_Text_GymGuidePostVictory',
            0x081FEE8A: 'MauvilleCity_Gym_Text_KirkIntro',
            0x081FEEAB: 'MauvilleCity_Gym_Text_KirkDefeat',
            0x081FEEBC: 'MauvilleCity_Gym_Text_KirkPostBattle',
            0x081FEED6: 'MauvilleCity_Gym_Text_ShawnIntro',
            0x081FEF00: 'MauvilleCity_Gym_Text_ShawnDefeat',
            0x081FEF0D: 'MauvilleCity_Gym_Text_ShawnPostBattle',
            0x081FEF48: 'MauvilleCity_Gym_Text_BenIntro',
            0x081FEF63: 'MauvilleCity_Gym_Text_BenDefeat',
            0x081FEF70: 'MauvilleCity_Gym_Text_BenPostBattle',
            0x081FEF99: 'MauvilleCity_Gym_Text_VivianIntro',
            0x081FEFB8: 'MauvilleCity_Gym_Text_VivianDefeat',
            0x081FEFC9: 'MauvilleCity_Gym_Text_VivianPostBattle',
            0x081FF019: 'MauvilleCity_Gym_Text_AngeloIntro',
            0x081FF02D: 'MauvilleCity_Gym_Text_AngeloDefeat',
            0x081FF03D: 'MauvilleCity_Gym_Text_AngeloPostBattle',
            0x081FF064: 'MauvilleCity_Gym_Text_WattsonIntro',
            0x081FF130: 'MauvilleCity_Gym_Text_WattsonDefeat',
            0x081FF165: 'MauvilleCity_Gym_Text_ReceivedDynamoBadge',
            0x081FF17F: 'MauvilleCity_Gym_Text_ExplainDynamoBadgeTakeThis',
            0x081FF1DF: 'MauvilleCity_Gym_Text_ExplainShockWave',
            0x081FF224: 'MauvilleCity_Gym_Text_RegisteredWattson',
            0x081FF240: 'MauvilleCity_Gym_Text_WattsonPostBattle',
            0x081FF265: 'MauvilleCity_Gym_Text_WattsonGoForthAndEndeavor',
            0x081FF283: 'MauvilleCity_Gym_Text_GymStatue',
            0x081FF292: 'MauvilleCity_Gym_Text_GymStatueCertified',
            0x081FF2B5: 'MauvilleCity_Gym_Text_WattsonPreRematch',
            0x081FF310: 'MauvilleCity_Gym_Text_WattsonRematchDefeat',
            0x081FF320: 'MauvilleCity_Gym_Text_WattsonPostRematch',
            0x081FF36A: 'MauvilleCity_Gym_Text_WattsonRematchNeedTwoMons',
        },
        'external_labels': {
            0x08242F10: 'Common_EventScript_ReadyPetalburgGymForBattle',
            0x08242FCF: 'Common_EventScript_SetGymTrainers',
        ...
        'field_placeholders': {
            0x081FEDC5: {0x01: 'PLAYER'},
            0x081FF165: {0x01: 'PLAYER'},
            0x081FF292: {0x01: 'PLAYER'},
        },
        'local_scripts': (0x081FE9BA,),
        'preserve_region_script_aliases': False,
        'preserve_region_text_aliases': False,
        'literal_result_commands': ('giveitem',),
        'symbols': {
            'flags': {
                0x0063: 'FLAG_MAUVILLE_GYM_BARRIERS_STATE',
                0x00A7: 'FLAG_RECEIVED_TM_SHOCK_WAVE',
                0x01D5: 'FLAG_ENABLE_WATTSON_MATCH_CALL',
                0x02FE: 'FLAG_HIDE_VERDANTURF_TOWN_SCOTT',
                0x04F2: 'FLAG_DEFEATED_MAUVILLE_GYM',
                0x0869: 'FLAG_BADGE03_GET',
            },
            'vars': {
                0x4085: 'VAR_PETALBURG_GYM_STATE',
            ...
            'trainers': {
                0x00BF: 'TRAINER_KIRK',
                0x00C2: 'TRAINER_SHAWN',
                0x010B: 'TRAINER_WATTSON_1',
                0x0143: 'TRAINER_BEN',
                0x0289: 'TRAINER_VIVIAN',
                0x0322: 'TRAINER_ANGELO',
            },
            'items': {0x0142: 'ITEM_TM_SHOCK_WAVE'},
            'songs': {0x01CC: 'MUS_REGISTER_MATCH_CALL'},
            'sounds': {0x002C: 'SE_UNLOCK'},
            'metatiles': {
                0x021A: 'METATILE_MauvilleGym_FloorTile',
                0x0222: 'METATILE_MauvilleGym_RedBeamH1_On',
                0x0223: 'METATILE_MauvilleGym_RedBeamH2_On',
                0x022A: 'METATILE_MauvilleGym_RedBeamH3_On',
                0x022B: 'METATILE_MauvilleGym_RedBeamH4_On',
                0x0230: 'METATILE_MauvilleGym_GreenBeamH1_Off',
                0x0231: 'METATILE_MauvilleGym_GreenBeamH2_Off',
                0x0238: 'METATILE_MauvilleGym_GreenBeamH3_Off',
                0x0239: 'METATILE_MauvilleGym_GreenBeamH4_Off',
                0x0241: 'METATILE_MauvilleGym_RedBeamV1_On',
                0x0242: 'METATILE_MauvilleGym_PoleBottom_On',
                0x0249: 'METATILE_MauvilleGym_RedBeamV2_On',
                0x0250: 'METATILE_MauvilleGym_PoleTop_On',
                0x0251: 'METATILE_MauvilleGym_PoleTop_Off',
            },
            'booleans': {0x00: 'FALSE', 0x01: 'TRUE'},
            'var_values': {
                0x8004: {0x00: '0', 0x01: '1', 0x02: '2', 0x03: '3'},
                0x800D: {0x00: 'FALSE'},
            },
            'script_var_values': {
                0x081FEB31: {0x800D: {0x01: 'TRUE'}},
            },
            'decimal_arguments': {
                'addvar': (1,),
                'call_if_eq': (1,),
