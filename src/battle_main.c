...
const u8 gTypeEffectiveness[336] BATTLE_MAIN_TYPE_DATA =
{
...
const struct TrainerMoney gTrainerMoneyTable[] BATTLE_MAIN_TRAINER_MONEY_DATA =
{
...
__attribute__((naked)) u8 GetWhoStrikesFirst(u8 battler1, u8 battler2, bool8 ignoreChosenMoves)
{
    __asm__(".syntax unified\n\t"
        ...
        "_0803CC68: .4byte gStatStageRatios\n\t"
        ...
        "_0803CD54: .4byte gStatStageRatios\n\t"
...
__attribute__((naked)) void HandleTurnActionSelectionState(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "_0803C0C4: .4byte BattleScript_PrintFullBox\n\t"
        ...
        "_0803C39C: .4byte BattleScript_PrintCantRunFromTrainer\n\t"
        ...
        "_0803C3FC: .4byte BattleScript_PrintCantEscapeFromBattle\n\t"
