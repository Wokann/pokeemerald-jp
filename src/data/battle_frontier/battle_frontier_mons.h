// Battle Frontier FacilityMon table, section-annotated for JP ROM placement.
// Regenerate with pokeemerald-jp-agent/tools/generate_battle_frontier_mons.py.

const struct FacilityMon gBattleFrontierMons[NUM_FRONTIER_MONS] BATTLE_FRONTIER_MONS_DATA =
{
