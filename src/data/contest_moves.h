CONTEST_EFFECT_DATA const struct ContestMove gContestMoves[MOVES_COUNT] =
{
    [MOVE_NONE] = {0},
...
CONTEST_EFFECT_DATA const struct ContestEffect gContestEffects[] =
{
...
CONTEST_EFFECT_DATA const bool8 gComboStarterLookupTable[] =
{
    FALSE,
    TRUE,
    TRUE,
...
CONTEST_EFFECT_DATA void (*const gContestEffectFuncs[])(void) =
{
    // JP ROM swaps this entry and CONTEST_EFFECT_HIGHLY_APPEALING (slot 42).
