const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("2003ねん　ちほう　たいかい");

const u8 gGiftRibbonDescriptionPart2_Champion[] = _("ゆうしょう　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("2003ねん　ぜんこく　たいかい");

const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("2003ねん　ワールドカップ");

const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("じゅんゆうしょう　きねんリボン");

const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("ベスト4　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("2004ねん　ちほう　たいかい");

const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("2004ねん　ぜんこく　たいかい");

const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("2004ねん　ワールドカップ");

const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("2005ねん　ちほう　たいかい");

const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("2005ねん　ぜんこく　たいかい");

const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("2005ねん　ワールドカップ");

const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("ポケモン　バトル　カップ");

const u8 gGiftRibbonDescriptionPart2_Participation[] = _("さんか　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("ポケモン　リーグ");

const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("アドバンス　カップ");

const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("ポケモンの　たいかいに");

const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("さんかした　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("ポケモンの　イベントに");

const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("ポケモンの　おまつりに");

const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("こんなんに　うちかった");

const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("きねんリボン");

const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("すべての　こんなんを");

const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("のりこえた　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("100にんぬき　たっせい");

const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("くらやみのとう　クリア");

const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("くれないのとう　クリア");

const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("くろがねのとう　クリア");

const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("さいごのとう　クリア");

const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("でんせつを　つくった");

const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("ポケモンセンタートウキョー");

const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("ポケモンセンターオーサカ");

const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("ポケモンセンターナゴヤ");

const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("ポケモンセンターニューヨーク");

const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("なつやすみ　きねんリボン");

const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");

const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("ふゆやすみ　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("はるやすみ　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("クリスマス　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("きねんび　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("がんばった　きねんの　リボン");

const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("ともだち　いっぱい　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("げんき　いっぱい　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("だいすきな　ポケモンに");

const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("つけてあげる　きねんリボン");

const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("ポケモンが　だいすきな　ことを");

const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("しょうめいする　リボン");
