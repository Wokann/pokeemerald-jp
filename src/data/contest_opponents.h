...
#define CONTEST_DEFAULT_WINNERS_DATA __attribute__((section(".rodata.contest_mid57b_default_winners")))
#define CONTEST_OPPONENTS_DATA __attribute__((section(".rodata.contest_mid57b_opponents")))
#define CONTEST_POSTGAME_FILTER_DATA __attribute__((section(".rodata.contest_mid57b_postgame_filter")))

CONTEST_DEFAULT_WINNERS_DATA const struct ContestWinner gDefaultContestWinners[] = {
...
CONTEST_OPPONENTS_DATA const struct ContestPokemon gContestOpponents[] =
{
    [CONTEST_OPPONENT_JIMMY] = {
...
CONTEST_POSTGAME_FILTER_DATA const u8 gPostgameContestOpponentFilter[] =
{
...
#undef CONTEST_POSTGAME_FILTER_DATA
#undef CONTEST_OPPONENTS_DATA
#undef CONTEST_DEFAULT_WINNERS_DATA
