...
{
    u8 menuType = FlagGet(FLAG_ADDED_MATCH_CALL_TO_POKENAV) != 0;
...
// Force the player to select Match Call during the call Mr. Stone Pok̩Nav tutorial
...
// After calling Mr. Stone during the Pok̩Nav tutorial, force player to exit or use Match Call again
