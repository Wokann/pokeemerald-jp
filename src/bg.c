...
// JP ROM-resident RAM (bound in sym_iwram_jp.txt).
extern IWRAM_DATA struct BgControl sGpuBgConfigs;
extern IWRAM_DATA struct BgConfig2 sGpuBgConfigs2[NUM_BACKGROUNDS];
