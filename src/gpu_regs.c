...
extern u8 sGpuRegBuffer[GPU_REG_BUF_SIZE];
extern u8 sGpuRegWaitingList[GPU_REG_BUF_SIZE];
extern volatile bool8 sGpuRegBufferLocked;
extern volatile bool8 sShouldSyncRegIE;
extern vu16 sRegIE;
