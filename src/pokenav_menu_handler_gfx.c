...
static void PrintCurrentOptionDescription(void)
{
    ...
    FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
    AddTextPrinterParameterized3(gfx->optionDescWindowId, FONT_NORMAL, (176 - width) / 2, 2, sOptionDescTextColors, 0, desc);
}
...
static void PrintNoRibbonWinners(void)
{
    ...
    FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
    AddTextPrinterParameterized3(gfx->optionDescWindowId, FONT_NORMAL, (176 - width) / 2, 2, sOptionDescTextColors2, 0, s);
}
