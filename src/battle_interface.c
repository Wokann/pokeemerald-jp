...
__attribute__((naked)) void UpdateLeftNoOfBallsTextOnHealthbox(u8 healthboxSpriteId)
{
    __asm__(".syntax unified\n\t"
        ...
        "bx r0\n\t"
        ".align 2, 0\n\t"
        "_080743D0: .4byte gDisplayedStringBattle\n\t"
        "_080743D4: .4byte gText_SafariBallLeft\n\t"
        "_080743D8: .4byte gNumSafariBalls\n\t"
        "_080743DC: .4byte gText_SafariBallsLeft2\n\t"
        "_080743E0: .4byte gSprites\n\t"
        "_080743E4: .4byte gMonSpritesGfxPtr\n\t"
