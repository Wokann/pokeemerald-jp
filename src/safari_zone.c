...
extern u8 sSafariZoneCaughtMons;
extern u8 sSafariZonePkblkUses;
extern struct PokeblockFeeder sPokeblockFeeders[NUM_POKEBLOCK_FEEDERS];

// JP asm name for the still-asm tv.s helper; US name: TryPutSafariFanClubOnAir.
void sub_080EEF6C(u8 monsCaught, u8 pokeblocksUsed);
...
{
    sub_080EEF6C(sSafariZoneCaughtMons, sSafariZonePkblkUses);
    ResetSafariZoneFlag();
    ClearAllPokeblockFeeders();
    gNumSafariBalls = 0;
...
void CB2_EndSafariBattle(void)
{
    ...
    {
        RunScriptImmediately(SafariZone_EventScript_Exit);
        WarpIntoMap();
