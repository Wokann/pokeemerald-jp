...
extern struct EReaderData gEReaderData;

extern const u8 gMultiBootProgram_EReader_Start[];
extern const u8 gMultiBootProgram_EReader_End[];

__attribute__((section(".rodata.ereader_screen_text")))
const u8 gJPText_LinkIsIncorrect[] =
{
    0x0E, 0x12, 0x40, 0x08, 0x37, 0x00, 0x1F, 0x11, 0x37, 0x50, 0x13, 0x02, 0x1F, 0x0D, 0xFF,
};

__attribute__((section(".rodata.ereader_screen_text")))
const u8 gJPText_CardReadingHasBeenHalted[] =
{
    0x56, 0xAE, 0x95, 0x19, 0x00, 0x26, 0x20, 0x0A, 0x20, 0x2D, 0xFE,
    0x11, 0x35, 0x03, 0x0C, 0x00, 0x0C, 0x1F, 0x0C, 0x10, 0xFF,
    0x56, 0xAE, 0x95, 0xD9, 0x78, 0xAE, 0x91, 0xAE, 0xF9, 0x04, 0x14, 0xFE,
    0x12, 0x03, 0x0C, 0x2E, 0x00, 0x44, 0x07, 0x1F, 0x0E, 0x2E, 0xFF,
};
