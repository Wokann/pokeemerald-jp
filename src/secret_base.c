...
__attribute__((naked)) const u8 *GetSecretBaseTrainerLoseText(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "_080EAEBC: .4byte gUnknown_824516F\n\t"
        "_080EAEC0:\n\t"
        "	cmp r0, #1\n\t"
        "	bne _080EAECC\n\t"
        "	ldr r0, _080EAEC8\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAEC8: .4byte gUnknown_8245374\n\t"
        "_080EAECC:\n\t"
        "	cmp r0, #2\n\t"
        "	bne _080EAED8\n\t"
        "	ldr r0, _080EAED4\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAED4: .4byte gUnknown_8245550\n\t"
        "_080EAED8:\n\t"
        "	cmp r0, #3\n\t"
        "	bne _080EAEE4\n\t"
        "	ldr r0, _080EAEE0\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAEE0: .4byte gUnknown_824573E\n\t"
        "_080EAEE4:\n\t"
        "	cmp r0, #4\n\t"
        "	bne _080EAEF0\n\t"
        "	ldr r0, _080EAEEC\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAEEC: .4byte gUnknown_82458F4\n\t"
        "_080EAEF0:\n\t"
        "	cmp r0, #5\n\t"
        "	bne _080EAEFC\n\t"
        "	ldr r0, _080EAEF8\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAEF8: .4byte gUnknown_824526D\n\t"
        "_080EAEFC:\n\t"
        "	cmp r0, #6\n\t"
        "	bne _080EAF08\n\t"
        "	ldr r0, _080EAF04\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAF04: .4byte gUnknown_8245455\n\t"
        "_080EAF08:\n\t"
        "	cmp r0, #7\n\t"
        "	bne _080EAF14\n\t"
        "	ldr r0, _080EAF10\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAF10: .4byte gUnknown_824565C\n\t"
        "_080EAF14:\n\t"
        "	cmp r1, #8\n\t"
        "	beq _080EAF20\n\t"
        "	ldr r0, _080EAF1C\n\t"
        "	b _080EAF22\n\t"
        "	.align 2, 0\n\t"
        "_080EAF1C: .4byte gUnknown_8245A06\n\t"
        "_080EAF20:\n\t"
        "	ldr r0, _080EAF28\n\t"
        "_080EAF22:\n\t"
        "	pop {r1}\n\t"
        "	bx r1\n\t"
        "	.align 2, 0\n\t"
        "_080EAF28: .4byte gUnknown_8245819\n\t"
        ".syntax divided\n\t"
    );
}
