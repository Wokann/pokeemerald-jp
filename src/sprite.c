...
// JP const data lives in the sprite data region (data.s).
extern const s8 sCenterToCornerVecTable[3][4][2];
...
extern u16 sSpriteTileRanges[MAX_SPRITES][2];
...
extern u16 sSpritePriorities[MAX_SPRITES];
extern u8 sSpriteOrder[MAX_SPRITES];
extern bool8 sShouldProcessSpriteCopyRequests;
extern u8 sSpriteCopyRequestCount;
extern struct SpriteCopyRequest sSpriteCopyRequests[MAX_SPRITES];
extern u8 gOamLimit;
extern u16 gReservedSpriteTileCount;
extern u8 sSpriteTileAllocBitmap[128];
