...
// JP byte-exact mprec helpers: keep naked asm for __mdiff/_ulp/_b2d/
// _d2b/_ratio/_mprec_log10 (agbcc-incompatible register allocation).
__attribute__((naked)) _Bigint *_DEFUN(diff, (ptr, a, b),
	struct _reent *ptr _AND _Bigint * a _AND _Bigint * b)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
...
__attribute__((naked)) double _DEFUN(ulp, (x), double x)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
        "push {r4, lr}\n\t"
...
__attribute__((naked)) double _DEFUN(b2d, (a, e), _Bigint *a _AND int *e)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
        "push {r4, r5, r6, r7, lr}\n\t"
...
__attribute__((naked)) _Bigint *_DEFUN(d2b, (ptr, d, e, bits),
...
__attribute__((naked)) double _DEFUN(ratio, (a, b), _Bigint *a _AND _Bigint *b)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
        "push {r4, r5, r6, r7, lr}\n\t"
...
__attribute__((naked)) double _mprec_log10(int n)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
        "push {r4, lr}\n\t"
