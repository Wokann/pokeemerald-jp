...
u8 GetMachBikeTransition(u8 *dirTraveling)
{
...
u8 CheckMovementInputAcroBike(u8 *newDirection, u16 newKeys, u16 heldKeys)
{
...
__attribute__((naked, section(".text.bike_stub_44"))) static void MovePlayerOnAcroBike(u8 direction, u16 newKeys, u16 heldKeys)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
        "	push {r4, lr}\n\t"
...
__attribute__((naked, section(".text.bike_stub_44"))) void sub_08119C44(void)
{
    __asm__(".syntax unified\n\t"
        ".code 16\n\t"
        "	pop {r4}\n\t"
