...
extern EWRAM_DATA u16 gPlttBufferUnfaded[PLTT_BUFFER_SIZE];
extern EWRAM_DATA u16 gPlttBufferFaded[PLTT_BUFFER_SIZE];
extern EWRAM_DATA struct PaletteStruct sPaletteStructs[NUM_PALETTE_STRUCTS];
extern EWRAM_DATA struct PaletteFadeControl gPaletteFade;
...
{
    LZDecompressVram(src, gPaletteDecompressionBuffer);
