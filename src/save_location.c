...
#define SAVE_LOCATION_DATA(name) __attribute__((section(".rodata.save_location_data." #name)))

SAVE_LOCATION_DATA(sSaveLocationPokeCenterList) const u16 sSaveLocationPokeCenterList[] =
{
...
SAVE_LOCATION_DATA(sSaveLocationReloadLocList) const u16 sSaveLocationReloadLocList[] =
{
    MAP_BATTLE_FRONTIER_BATTLE_TOWER_LOBBY,
    LIST_END,
};

SAVE_LOCATION_DATA(sEmptyMapList) const u16 sEmptyMapList[] =
{
    LIST_END,
};
