...
// JP ROM-resident RAM (bound in sym_iwram_jp.txt; the C object's own
// bss/COMMON sections are not placed by the linker).
extern IWRAM_DATA u8 sTimerNum;
extern IWRAM_DATA u16 sTimerCount;
extern IWRAM_DATA vu16 *sTimerReg;
extern IWRAM_DATA u16 sFlashSavedIme;

extern IWRAM_DATA u8 gFlashTimeoutFlag;
extern IWRAM_DATA u8 (*PollFlashStatus)(u8 *);
extern IWRAM_DATA u16 (*WaitForFlashWrite)(u8 phase, u8 *addr, u8 lastData);
extern IWRAM_DATA u16 (*ProgramFlashSector)(u16 sectorNum, u8 *src);
extern IWRAM_DATA const struct FlashType *gFlash;
extern IWRAM_DATA u16 (*ProgramFlashByte)(u16 sectorNum, u32 offset, u8 data);
extern IWRAM_DATA u16 gFlashNumRemainingBytes;
extern IWRAM_DATA u16 (*EraseFlashChip)();
extern IWRAM_DATA u16 (*EraseFlashSector)(u16 sectorNum);
extern IWRAM_DATA const u16 *gFlashMaxTime;
