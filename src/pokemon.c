...
POKEMON_FRONT_ANIMATION_TABLE_DATA static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
...
POKEMON_FRONT_ANIMATION_TABLE_DATA static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
...
__attribute__((naked)) void DoMonFrontSpriteAnimation(struct Sprite *sprite, u16 species, bool8 noCry, u8 panModeAnimFlag)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _0806E884\n\t"
        "	.align 2, 0\n\t"
        "_0806E868: .4byte sMonAnimationDelayTable\n\t"
        "_0806E86C: .4byte Task_AnimateAfterDelay + 1\n\t"
        "_0806E870: .4byte gTasks\n\t"
        "_0806E874: .4byte sMonFrontAnimIdsTable\n\t"
        "_0806E878:\n\t"
        "	ldr r0, _0806E890\n\t"
        "	adds r0, r4, r0\n\t"
        "	ldrb r1, [r0]\n\t"
        ...
        "	bx r0\n\t"
        "	.align 2, 0\n\t"
        "_0806E890: .4byte sMonFrontAnimIdsTable\n\t"
...
__attribute__((naked)) void PokemonSummaryDoMonAnimation(struct Sprite *sprite, u16 species, bool8 oneFrame)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _0806E918\n\t"
        "	.align 2, 0\n\t"
        "_0806E8FC: .4byte sMonAnimationDelayTable\n\t"
        "_0806E900: .4byte Task_PokemonSummaryAnimateAfterDelay + 1\n\t"
        "_0806E904: .4byte gTasks\n\t"
        "_0806E908: .4byte sMonFrontAnimIdsTable\n\t"
        "_0806E90C:\n\t"
        "	ldr r0, _0806E920\n\t"
        "	adds r0, r4, r0\n\t"
        "	ldrb r1, [r0]\n\t"
        ...
        "	bx r0\n\t"
        "	.align 2, 0\n\t"
        "_0806E920: .4byte sMonFrontAnimIdsTable\n\t"
        ".syntax divided\n\t"
    );
}
