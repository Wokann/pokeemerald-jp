...
#define ROAMER_LOCATIONS_DATA __attribute__((section(".rodata.roamer_locations_data")))

static const u8 sRoamerLocations[][6] ROAMER_LOCATIONS_DATA =
{
...
// The original table is followed by two explicit bytes before the Frontier data.
static const u8 sRoamerLocationsPadding[2] ROAMER_LOCATIONS_DATA = {0};
