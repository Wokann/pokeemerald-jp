...
// CallBattlePalaceFunction and the 2-byte sub_08195574 placeholder live
// in asm/battle_palace_jp_only.s to keep the literal pool layout.
void CallBattlePalaceFunction(void);
void sub_08195574(void);
