...
// bss is not placed by the linker).
extern IWRAM_DATA u8 sGlobalScriptContextStatus;
extern IWRAM_DATA struct ScriptContext sGlobalScriptContext;
extern IWRAM_DATA struct ScriptContext sImmediateScriptContext;
extern IWRAM_DATA bool8 sLockFieldControls;
