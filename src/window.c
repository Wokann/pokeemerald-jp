...
extern IWRAM_DATA u8 gTransparentTileNumber;
extern IWRAM_DATA void *gWindowBgTilemapBuffers[NUM_BACKGROUNDS];
extern IWRAM_DATA u32 gWindowTileAutoAllocEnabled;
extern EWRAM_DATA struct Window gWindows[WINDOWS_MAX];
