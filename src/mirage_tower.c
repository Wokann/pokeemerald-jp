...
// The disintegration tile effect and the falling-fossil sprite callback live
// in asm/berry_fix_program.s (they were misnamed CB2_InitBerryFixProgram /
// berry_fix_text_update there and are now renamed to match the US decomp).
void UpdateDisintegrationEffect(u8 *tiles, u16 randId, u8 c, u8 size, u8 offset);
