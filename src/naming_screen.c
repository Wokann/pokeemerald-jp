...
__attribute__((naked)) void HandleDpadMovement(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _080E3CE4\n\t"
        "	.align 2, 0\n\t"
        "_080E3CB8: .4byte gUnknown_8565AC0\n\t"
        "_080E3CBC: .4byte gUnknown_8565ACA\n\t"
        "_080E3CC0: .4byte gUnknown_8565AD4\n\t"
        "_080E3CC4: .4byte gUnknown_8565ADC\n\t"
...
__attribute__((naked)) void sub_080E3E7C(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "_080E3EE8: .4byte gUnknown_8565B00\n\t"
        ".syntax divided\n\t"
    );
}
...
__attribute__((naked)) void sub_080E40A8(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "_080E40E4: .4byte gUnknown_8565B06\n\t"
        "_080E40E8: .4byte gUnknown_8565BC1\n\t"
        "_080E40EC:\n\t"
        "	adds r2, #1\n\t"
        "	adds r4, #1\n\t"
        "	ldrb r0, [r2]\n\t"
...
__attribute__((naked)) void sub_080E44A4(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	bx r0\n\t"
        "	.align 2, 0\n\t"
        "_080E450C: .4byte gUnknown_8565C7B\n\t"
        ".syntax divided\n\t"
    );
}
