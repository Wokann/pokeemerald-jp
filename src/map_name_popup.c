...
extern const u8 sMapSectionToThemeId[];
extern const u8 sMapPopUp_OutlineTable[][960];
extern const u16 sMapPopUp_Palette_Underwater[16];
extern const u16 sMapPopUp_PaletteTable[][16];
extern const u8 sMapPopUp_Table[][960];
