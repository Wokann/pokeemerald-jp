...
__attribute__((naked)) void Task_LoadShowMons(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "_0817599C: .4byte gIntroCredits_MovingSceneryState\n\t"
...
__attribute__((naked)) void Task_BikeScene(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _081762A0\n\t"
        "	.align 2, 0\n\t"
        "_08176278: .4byte gIntroCredits_MovingSceneryVOffset\n\t"
        "_0817627C:\n\t"
        "	ldr r7, _081762A8\n\t"
        "	movs r3, #0\n\t"
        "	ldrsh r4, [r7, r3]\n\t"
        ...
        "	b _08176424\n\t"
        "	.align 2, 0\n\t"
        "_081762A8: .4byte gIntroCredits_MovingSceneryVOffset\n\t"
        "_081762AC:\n\t"
        "	ldr r3, _081762CC\n\t"
        "	lsls r1, r5, #2\n\t"
        "	adds r1, r1, r5\n\t"
        ...
        "	b _08176424\n\t"
        "	.align 2, 0\n\t"
        "_08176370: .4byte gIntroCredits_MovingSceneryVOffset\n\t"
        "_08176374:\n\t"
        "	ldr r2, _08176390\n\t"
        "	movs r3, #0xc\n\t"
        "	ldrsh r1, [r4, r3]\n\t"
...
__attribute__((naked)) void LoadBikeScene(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	strh r0, [r1]\n\t"
        "	adds r0, r4, #0\n\t"
        "	bl LoadCreditsSceneGraphics\n\t"
        "	ldrb r0, [r6]\n\t"
        "	adds r0, #1\n\t"
        "	strb r0, [r6]\n\t"
        "	b _08176A9E\n\t"
        "	.align 2, 0\n\t"
        "_08176954: .4byte gIntroCredits_MovingSceneryVBase\n\t"
        "_08176958: .4byte gIntroCredits_MovingSceneryVOffset\n\t"
        "_0817695C:\n\t"
        "	ldr r0, _081769BC\n\t"
        "	ldr r0, [r0]\n\t"
        "	ldrb r0, [r0, #8]\n\t"
        ...
        "_081769C0: .4byte gSpriteSheet_CreditsBrendan\n\t"
        "_081769C4: .4byte gSpriteSheet_CreditsRivalMay\n\t"
        "_081769C8: .4byte gSpriteSheet_CreditsBicycle\n\t"
        "_081769CC: .4byte gSpritePalettes_Credits\n\t"
        ...
        "	b _08176A9E\n\t"
        "	.align 2, 0\n\t"
        "_08176A5C: .4byte gSpriteSheet_CreditsMay\n\t"
        "_08176A60: .4byte gSpriteSheet_CreditsRivalBrendan\n\t"
        "_08176A64: .4byte gSpriteSheet_CreditsBicycle\n\t"
        "_08176A68: .4byte gSpritePalettes_Credits\n\t"
...
__attribute__((naked)) void ResetCreditsTasks(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "_08176B20: .4byte gIntroCredits_MovingSceneryState\n\t"
        ".syntax divided\n\t"
    );
}
...
__attribute__((naked)) void SpriteCB_Player(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _08176E14\n\t"
        "	.align 2, 0\n\t"
        "_08176D8C: .4byte gIntroCredits_MovingSceneryState\n\t"
        "_08176D90:\n\t"
        "	movs r2, #0x2e\n\t"
        "	ldrsh r0, [r4, r2]\n\t"
        "	cmp r0, #5\n\t"
...
__attribute__((naked)) void SpriteCB_Rival(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _08176ED4\n\t"
        "	.align 2, 0\n\t"
        "_08176E34: .4byte gIntroCredits_MovingSceneryState\n\t"
        "_08176E38:\n\t"
        "	movs r1, #0x2e\n\t"
        "	ldrsh r0, [r4, r1]\n\t"
        "	cmp r0, #1\n\t"
        ...
        "	b _08176ED4\n\t"
        "	.align 2, 0\n\t"
        "_08176E98: .4byte gIntroCredits_MovingSceneryVOffset\n\t"
        "_08176E9C:\n\t"
        "	ldrh r0, [r4, #0x3c]\n\t"
        "	adds r0, #1\n\t"
        "	strh r0, [r4, #0x3c]\n\t"
...
__attribute__((naked)) void SpriteCB_CreditsMon(void)
{
    __asm__(".syntax unified\n\t"
        ...
        "	b _081770A8\n\t"
        "	.align 2, 0\n\t"
        "_08176EF4: .4byte gIntroCredits_MovingSceneryState\n\t"
        "_08176EF8:\n\t"
        "	ldrh r0, [r5, #0x3c]\n\t"
        "	adds r0, #1\n\t"
        "	strh r0, [r5, #0x3c]\n\t"
...
__attribute__((naked)) void SpriteCB_CreditsMonBg(struct Sprite *sprite)
{
    __asm__(".syntax unified\n\t"
        ...
        "_08177174: .4byte gIntroCredits_MovingSceneryState\n\t"
        "_08177178:\n\t"
        "	adds r0, r1, #0\n\t"
        "	adds r0, #0x3e\n\t"
        "	ldrb r0, [r0]\n\t"
