...
u8 GetAcroWheelieFaceDirectionMovementAction(struct ObjectEvent *, struct Sprite *);
u8 GetAcroPopWheelieFaceDirectionMovementAction(struct ObjectEvent *, struct Sprite *);
u8 GetAcroEndWheelieFaceDirectionMovementAction(u32);
u8 GetAcroWheelieHopFaceDirectionMovementAction(struct ObjectEvent *, struct Sprite *);
u8 GetAcroWheelieHopDirectionMovementAction(u32);
u8 GetAcroWheelieJumpDirectionMovementAction(struct ObjectEvent *, struct Sprite *);
