...
typedef union // size = 0x24
{
    ...
    struct {
        ...
        /*0x01*/ bool8 active;
        /*0x02*/ u16 species;
        /*0x04*/ u8 pokemonName[POKEMON_NAME_STORAGE_LENGTH + 1];
    ...
    struct {
        ...
        /*0x02*/ u16 species;
        /*0x04*/ u16 words[2];
        /*0x08*/ u8 pokemonNickname[POKEMON_NAME_STORAGE_LENGTH + 1];
    ...
    struct {
        ...
        /*0x0B*/ u8 nickname[POKEMON_NAME_STORAGE_LENGTH + 1];
    ...
    struct {
        ...
        /*0x02*/ u8 language;
        /*0x03*/ u8 language2;
        /*0x04*/ u8 nickname[POKEMON_NAME_STORAGE_LENGTH + 1];
        /*0x0F*/ u8 ball;
        /*0x10*/ u16 species;
        /*0x12*/ u8 nBallsUsed;
